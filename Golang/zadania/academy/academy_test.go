	...
	testCases := []struct {
	...
	}{
		{
			...
			student: Student{
				...
				Project:   5,
				Attendace: []bool{true, true, true, true, true},
			},
			expected: 5,
		},
		{
			...
			student: Student{
				...
				Grades:    []int{5, 4, 5, 5, 5},
				Project:   5,
				Attendace: []bool{true, false, true, true, false},
			},
			expected: 4,
		},
		{
			...
			student: Student{
				...
				Grades:    []int{5, 4, 5, 5, 5},
				Project:   4,
				Attendace: []bool{true, false, false, true, false},
			},
			expected: 1,
		},
		{
		...
		students := []Student{
			{
				...
				Project:   5,
				Attendace: []bool{true, true, false, true, true, true},
			},
			{
				Name:      "Jane",
				Grades:    []int{5, 5, 5, 5, 5},
				Project:   5,
				Attendace: []bool{true, true, true, true, true, true},
			},
		}
		expected := map[string]uint8{
			"John": 5,
